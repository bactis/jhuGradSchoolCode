        ...
        while byte != "":
            ...
            #If instruction is valid
                ...
                while instruction['Done'] == False:
                    ...
                    ''''
                    #for complex Op Codes that need more than 1 byte to properly identify
                    ...
                    if(instruction['OptCode'] == 'ret' and instruction['Done'] == False and instruction['modrm'] == False):
                        for x in range(0,2):
                            ...
                            if x != 0:
                                ...
                                #instruction['src'] = instruction['src'][:1]
                    ...
                    if(instruction['OptCode'] == 'jcc' and instruction['Done'] == False and instruction['modrm'] == False):
                         ...
                         #debugging
                         print "type of byte is: ",
                         print type(byte),
                         print "\t type of eip is: ",
                         print type(eip)
            ...
            instruction = {
                ...
                'Bytes': None,          #     String for bytes. 2nd column of output
                'OptCode': '?',         #     3rd column of output the add, xor, mov, push, pop etc
                'modrm': None,          #     ? set to false to skip
                'opEn': None,           #     operator encoding
                'sib': None,            #     ?
                'displacement': None,   #     ?
                'immediate': False,     #     Boolean value if an immediate is used
                'instruction': None,    #     ?
...
def identifyOptCode(byte, instruction):
    ...
    optCode = {
        ...
        #CALL ------------------------------------------------------------------------------------------
        'e8': 'call',                       #CALL near relative displacement        NOT DONE
        ...
        #PUSH's ---------------------------------------------
        'ff': 'push',   # 2byte opt codes here                 #                                NOT DONE r/m32
...
def printInstruction(instruction):
        ...
        if instruction['dst'] != None and instruction['OptCode'] != 'ret' and instruction['src']!= '':
